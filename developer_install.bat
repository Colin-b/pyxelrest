...
python pyxelrest_install_addin.py --add_in_directory addin/AutoLoadPyxelRestAddIn/bin/Release --vb_add_in_directory addin --path_to_up_to_date_configuration "%path_to_conf%"
GOTO End
