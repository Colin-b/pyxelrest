...
<a href="https://github.com/Colin-b/pyxelrest/actions"><img alt="Number of tests" src="https://img.shields.io/badge/tests-392 passed-blue"></a>
...
* [Python >= 3.6](https://www.python.org/downloads/) must be installed (with `pip` and `tkinter` for auto update to work).
