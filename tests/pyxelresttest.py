...
class PyxelRestTest(unittest.TestCase):
    ...
    def test_optional_array_integer_parameter_with_wrong_type(self):
        import pyxelrest
        self.assertEqual(pyxelrest.test_get_test_json_with_all_optional_parameters_types(query_array_integer='str value'),
    ...
    def test_optional_array_integer32_parameter_with_wrong_type(self):
        import pyxelrest
        self.assertEqual(pyxelrest.test_get_test_json_with_all_optional_parameters_types(query_array_integer32='str value'),
    ...
    def test_optional_array_integer64_parameter_with_wrong_type(self):
        import pyxelrest
        self.assertEqual(pyxelrest.test_get_test_json_with_all_optional_parameters_types(query_array_integer64='str value'),
    ...
    def test_optional_array_number_parameter_with_wrong_type(self):
        import pyxelrest
        self.assertEqual(pyxelrest.test_get_test_json_with_all_optional_parameters_types(query_array_number='str value'),
    ...
    def test_optional_array_double_parameter_with_wrong_type(self):
        import pyxelrest
        self.assertEqual(pyxelrest.test_get_test_json_with_all_optional_parameters_types(query_array_double='str value'),
    ...
    def test_optional_array_boolean_parameter_with_wrong_type(self):
        import pyxelrest
        self.assertEqual(pyxelrest.test_get_test_json_with_all_optional_parameters_types(query_array_boolean='non boolean'),
    ...
    def test_optional_array_date_time_parameter_with_wrong_type(self):
        import pyxelrest
        self.assertEqual(pyxelrest.test_get_test_json_with_all_optional_parameters_types(query_array_date_time='str value'),
